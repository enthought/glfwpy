...
void main(void)
{
    fout_color = vec4(texture(texture_sampler, vout_uv).rgb, 1);
}
"""
...
if __name__ == "__main__":
    ...
    if not OpenWindow(600, 600, 0, 0, 0, 0, 32, 0, WINDOW):
    ...
    SetWindowTitle("Texturing example")
